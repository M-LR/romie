...
export const Login = () => {
    ...
    const [classError, setClassError] = useState(
        'bg-indigo-600 h-5 rounded-md text-white text-center'
    )

    //On change le title en fonction du composent au chargement de celui-ci
    useEffect(() => {
    ...
    //https://openclassrooms.com/fr/courses/7008001-debutez-avec-react/7136084-interagissez-avec-vos-composants-grace-aux-evenements
    ...
    return (
        <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8 ">
            <div className="w-full max-w-md space-y-8">
                <div>
                    <img
                        className="mx-auto w-auto inline-block rounded-full ring-2 ring-white"
                        src="./img/undraw_dog_c7i6.svg"
                        alt="Your Company"
                    />
                ...
                <p className={classError}>{errorMsg}</p>
                <form
